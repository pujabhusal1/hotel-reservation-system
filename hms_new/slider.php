<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="images/cootage.jpg" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
              <h5>Out side Environment</h5>
              <p>The Cottage is totally made up of wood and customers xan feel the nature and enjoy their time</p>
            </div>
          </div>
