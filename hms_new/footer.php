...
<script src="https://kit.fontawesome.com/5c62d2b735.js" crossorigin="anonymous"></script>
...
<div class="footer">
  ...
  <section class="d-flex justify-content-none justify-content-lg-between p-4 border-bottom">
</div>
    <!-- Left -->
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas  me-3"></i><h1>The new View Resorts
          </h1>
          <p>
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          ...
          <p><i class="fa fa-home me-3"></i> The New View Resort</p>
          <p>
            <i class="fa fa-envelope me-3"></i>
            newview@example.com
          </p>
          <p><i class="fa fa-phone me-3"></i> +9865197049</p>
          <p><i class="fa fa-print me-3"></i> + 89489849</p>
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2023 new view:
    <a class="text-reset fw-bold" href="https://mdbootstrap.com/">resorts </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->